...
- [MailTwin](https://www.mailtwin.ai/) - Writes replies inside Apple Mail on the Mac from a few typed points, in a writing style learned locally and separately for each mail account, using your own key across eight providers.
